...
public class WorldGenGrape extends WorldGenerator {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        for (int var6 = 0; var6 < 64; ++var6) {
            ...
            if (par1World.isAirBlock(var7, var8, var9) && par1World.getBlockId(var7, var8 - 1, var9) == Block.grass.blockID && Block.pumpkin.canPlaceBlockAt(par1World, var7, var8, var9)) {
                par1World.setBlock(var7, var8 - 1, var9, Block.tilledField.blockID);
                par1World.setBlock(var7, var8, var9, ModBlocks.grapeBlock.blockID, 7, 2);
            }
        }
