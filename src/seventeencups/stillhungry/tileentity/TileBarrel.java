        ...
        if (!this.worldObj.isRemote) {
            if (this.isFilled == 0) {
                if (this.fruitType == 0 && this.inv[0] != null) {
                    if (this.inv[0].isItemEqual(new ItemStack(Item.bucketWater))) {
                        var2 = true;
                        this.inv[0] = new ItemStack(Item.bucketEmpty, 1);
                        isFilled = 1;
                    }
                }
            } else {
                if (this.fruitType == 0 && this.fruitLevel < 4 && this.inv[0] != null) {
                    ...
                    if (this.inv[0].isItemEqual(new ItemStack(Item.appleRed))) {
                        fruitType = 2;
                    }
                ...
                if (this.hasSugar == 0 && this.inv[0] != null) {
                    if (this.inv[0].isItemEqual(new ItemStack(Item.sugar))) {
                        var2 = true;
                        decrStackSize(0, 1);
                        hasSugar = 1;
                    }
