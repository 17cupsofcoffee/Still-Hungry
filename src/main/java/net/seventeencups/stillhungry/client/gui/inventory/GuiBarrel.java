...
public class GuiBarrel extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2,
        ...
        mc.renderEngine.bindTexture(new ResourceLocation(StillHungry.modid + ":textures/gui/barrelBack.png"));
        int x = (width - xSize) / 2;
        ...
        mc.renderEngine.bindTexture(new ResourceLocation(StillHungry.modid + ":textures/gui/barrelFore.png"));
        this.drawTexturedModalRect(x, y, 0, 0, this.xSize, this.ySize);
